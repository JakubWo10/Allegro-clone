...
class DatabaseClient():
    ...
    _tables: Dict = {
        "Users":{
            "columns": ("name", "email", "hashed_password", "image_source")
        },
        "Product":{
            "columns":("name", "price", "description", "owner_id", "category", "main_image", "quantity")
        },
        "Comments": {
            "columns":("autor_id", "product_id", "description")
        }
    }
